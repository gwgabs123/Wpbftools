...
if len(sys.argv) <= 1:
    print 'ngehek copiret 2020'
    print 'Coded: IndoXbackHT'
    print '-u user'
    print '-p pass'
    print '#berdoa sebelum Brute Force(islam)'
    print '#kalo bukan islam ya Berdoa Sesuai Agama Masing'
    print '#Satanic Dilarang!'
    sys.exit()

print 'C 2020'
print 'Coded: IndoXblackHT'
...
try:
    ...
    #Finish
    print ''       
    print '1 target sukses , '+ str(countAcc) +' mendapatan user and pass Didapatkan!'
    print 'TARGER: ' + url
    print 'RESULT:'        
    print result
    sys.exit()
except urllib2.URLError, e:
    print "\n\t[!] Sesi Dibatalkan!; Error . Cek internet"
except (KeyboardInterrupt):
    print "\n\t[!] Cie Gagal BruteForce:v"